view: daily_inventory_summary_old {
  sql_table_name: `cloudfit-saas-prd.moderato.daily_inventory_summary_old`
    ;;
  drill_fields: [id]
  ...
  　link: {
      label: "日次在庫一覧(SKU別)へ"
      url: "https://cloudfit-metrics.com/reports/31?reportParams={{daily_inventory_summary_old.param1._value}}"
      }
